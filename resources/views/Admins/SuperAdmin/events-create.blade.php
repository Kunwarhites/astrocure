                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-md-12 bg-light mb-4 p-2">
                                    <a href="{{ route('dashboard') }}"><i class="fa-solid fa-home"></i> home</a> / Events /
                                    Create
                                </div>
                                <div class="col-md-12">
                                    <form action="" autocomplete="off" method="POST" id="eventCreateForm">
                                        @csrf
                                        <div class="mb-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        ...
                                                        <input type="num"  name="rate"  class="form-control">
                                                    </div>
                                                    <div class="col-md-4 mb-4">
                                                    ...
                                                    <div class="col-md-12 mb-4">
                                                        ...
                                                        <input type="text"  name="organized"  class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <button type="submit" name="submit" id="event_btn"
