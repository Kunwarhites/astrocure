                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-md-12 bg-light mb-4 p-2">
                                    <a href="{{ route('dashboard') }}"><i class="fa-solid fa-home"></i> home</a> / Service /
                                    Create
                                </div>
                                <div class="col-md-12">
                                    <form action="" autocomplete="off" method="POST" id="serviceEditForm">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <img src="{{ url('./uploads/services/thumb/small/'.$service->image)}}" alt="" width="300" class="img-thumbnail my-4 rounded-5">
                                            </div>
                                            <div class="col-md-6 mb-3">
    ...
    <script>
        ...
        const dropzone = $("#image").dropzone({
         ...
         $("#serviceEditForm").submit(function(e) {
            ...
            $.ajax({
                url: '{{ route('updateService', $service->id) }}',
                method: 'POST',
                dataType: 'json',
                data: formData,
                cache: false,
