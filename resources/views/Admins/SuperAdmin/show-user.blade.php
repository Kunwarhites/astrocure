                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                class="img-fluid rounded-circle  img-thumbnail" style="height: 150px; width:150px; background-sizen:cover;">
                                <div class="mt-3">
                                    <h4>{{$users->name}}</h4>
                ...
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a class="btn btn-info" href="{{ route('editUsers', ['id' => $users->id]) }}">Edit</a>
