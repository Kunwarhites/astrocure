                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="col-md-12 bg-light mb-4 p-2">
                                    <a href="{{ route('dashboard') }}"><i class="fa-solid fa-home"></i> home</a> / Blog /
                                    Edit
                                </div>
                                <div class="col-md-12">
                                    <form action="" autocomplete="off" method="POST" id="serviceEditForm">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Name</label>
                                            <input type="text" value="{{ $service->name}}" class="form-control error_message" name="name"
                                                id="name">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <img src="{{ url('./uploads/blogs/thumb/smalls/'.$service->picture)}}" alt="" width="300" class="img-thumbnail my-4 rounded-5">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="exampleInputPassword1" class="form-label">Short
                                                    Description</label>
                                                <textarea name="short_description" id="short_description" class="form-control" cols="30" rows="7"> {{ $service->short_description}}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="by" id="by" class="form-control">
                                                    ...
                                                    <option value="{{$by->id}}" {{ ($service->by == $by->id) ? 'selected' : ''}}>{{$by->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
    ...
    <script>
        ...
        const dropzone = $("#image").dropzone({
         ...
         $("#serviceEditForm").submit(function(e) {
            ...
            $.ajax({
                url: '{{ route('blogupdate', $service->id) }}',
                method: 'POST',
                dataType: 'json',
                data: formData,
                cache: false,
